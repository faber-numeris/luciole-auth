...
func encodeConfirmUserRegistrationResponse(response ConfirmUserRegistrationRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *ConfirmUserRegistrationBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
	...
	case *ConfirmUserRegistrationGone:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(410)
	...
	case *ConfirmUserRegistrationInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
