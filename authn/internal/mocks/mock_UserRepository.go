...
import (
	...
	outbound "github.com/faber-numeris/luciole-auth/authn/internal/app/ports/outbound"
)
...
func (_m *MockUserRepository) ListUsers(ctx context.Context, params *outbound.ListUsersParams) ([]*domain.User, error) {
	...
	var r0 []*domain.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *outbound.ListUsersParams) ([]*domain.User, error)); ok {
		return rf(ctx, params)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *outbound.ListUsersParams) []*domain.User); ok {
		r0 = rf(ctx, params)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*domain.User)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *outbound.ListUsersParams) error); ok {
		r1 = rf(ctx, params)
	} else {
		r1 = ret.Error(1)
	}
...
//   - ctx context.Context
//   - params *outbound.ListUsersParams
...
func (_c *MockUserRepository_ListUsers_Call) Run(run func(ctx context.Context, params *outbound.ListUsersParams)) *MockUserRepository_ListUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*outbound.ListUsersParams))
	})
	return _c
}
...
func (_c *MockUserRepository_ListUsers_Call) RunAndReturn(run func(context.Context, *outbound.ListUsersParams) ([]*domain.User, error)) *MockUserRepository_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
