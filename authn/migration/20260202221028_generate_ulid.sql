...
DROP FUNCTION generate_ulid(output_base text default 'base32', prefix text default NULL, delimiter text default '_');
DROP FUNCTION hex_to_base(hexstr TEXT, base_alphabet TEXT);
